...
locals {
  ...
  core_roles = [
    ...
    {
      role_id      = "/subscriptions/${data.azurerm_subscription.current.subscription_id}/providers/Microsoft.Authorization/roleDefinitions/b6329e09-8f32-bfca-fa4f-f2e4d90fd3ff" // Container App Log Reader
      principal_id = data.azuread_group.admin_group.object_id
    }
  ]
  ...
  semarchy-urls = {
    ...
    ithc = "https://csds.ithc.apps.hmcts.net/api/rest"
